...
const navbar = () => {
  return (
    <nav className="bg-white rounded-xl shadow-md">
      <div className="relative flex max-w-full-xl flex-col overflow-hidden px-4 py-4 md:mx-auto md:flex-row md:items-center bg-white rounded-3xl">
        <img
          src={logo}
          alt="profile"
        ...
        <span className="text-black text-sm flex items-center whitespace-nowrap font-black">
          admin name
        </span>
